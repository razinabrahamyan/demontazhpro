...
<head>
    ...
    <style>
        .page_404{padding:40px 0;background:#fff;font-family:Arvo,serif;text-align:center}.page_404 img{width:100%}.four_zero_four_bg{background-repeat: no-repeat;background-image:url(https://cdn.dribbble.com/users/285475/screenshots/2083086/dribbble_1.gif);height:400px;background-position:center}.four_zero_four_bg h1{font-size:80px}.four_zero_four_bg h3{font-size:80px}.link_404{font-size: 19px;text-decoration: none;color:#fff!important;padding:10px 20px;background:#ff7800;margin:20px 0;display:inline-block;border-radius:30px}.contant_box_404{margin-top:-50px}
    </style>
</head>
<body>
            ...
            <div class="col-sm-12 ">
                <div class="col-sm-10 col-sm-offset-1  text-center">
                    ...
                    <div class="contant_box_404">
                        ...
                        <a href="{{route('welcome')}}" class="link_404">На главную</a>
                    </div>
                </div>
            </div>
        </div>
